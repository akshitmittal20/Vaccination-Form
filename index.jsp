...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td colspan="3" align="center" valign="top"><img src="img/1.png" width="1200" height="270" /></td>
        </tr>
        <tr>
          <td colspan="3" align="right" valign="top" bgcolor="#000000">&nbsp;</td>
        </tr>
        <tr>
          <td width="79%" align="right" valign="top" bgcolor="#EDFFFF"><a href="Inputorm.jsp"><img src="img/2.png" width="210" height="63" /></a></td>
          <td width="0%" align="right" valign="top" bgcolor="#EDFFFF">&nbsp;</td>
          <td width="21%" align="right" valign="top" bgcolor="#EDFFFF"><a href="ViewReportDetails.jsp"><img src="img/vv.jpg" width="210" height="63" border="2" /></a></td>
    </tr>
        <tr>
          <td colspan="3" align="center" valign="top"><p>&nbsp;</p>
          <p><img src="FirstImage/1.jpg" width="1100" height="400" border="0" id="id1" onclick="first()" /></p></td>
    </tr>
        <tr>
          <td colspan="3" align="center" valign="top">&nbsp;</td>
        </tr>
        <tr>
          <td colspan="3" align="center" valign="top" bgcolor="#000000">Copyright &copy; 2021</td>
        </tr>
  </table>
</form>
</body>
